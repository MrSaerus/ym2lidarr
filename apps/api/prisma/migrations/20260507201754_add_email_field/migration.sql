...
CREATE TABLE "new_Setting" (
    ...
    "enableCronNavidromeBackfill" BOOLEAN NOT NULL DEFAULT false,
    ...
    "cronNavidromeBackfill" TEXT DEFAULT '30 */6 * * *',
...
INSERT INTO "new_Setting" ("allowRepush", "backupCron", "backupDir", "backupEnabled", "backupRetention", "copyInProgress", "createdAt", "cronCustomMatch", "cronCustomPush", "cronLidarr", "cronLidarrPull", "cronNavidromePush", "cronTorrentCopyDownloaded", "cronTorrentQbtPoll", "cronTorrentRunUnmatched", "cronYandex", "cronYandexMatch", "cronYandexPull", "cronYandexPush", "customMatchForce", "enableCronCustomMatch", "enableCronCustomPush", "enableCronLidarrPull", "enableCronNavidromePush", "enableCronTorrentCopyDownloaded", "enableCronTorrentQbtPoll", "enableCronTorrentRunUnmatched", "enableCronYandexMatch", "enableCronYandexPull", "enableCronYandexPush", "enableExport", "enablePush", "exportPath", "fileOpMode", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrPullTarget", "lidarrUrl", "likesPolicySourcePriority", "matchRetryDays", "mbMatchForce", "metadataProfileId", "mode", "monitor", "musicAlbumFolderPattern", "musicArtistFolderPattern", "musicDiscFolderPattern", "musicLibraryDir", "musicTrackFilePattern", "musicVariousArtistsName", "navidromePass", "navidromeSalt", "navidromeSyncTarget", "navidromeToken", "navidromeUrl", "navidromeUser", "notifyType", "pushTarget", "pyproxyUrl", "qbtDeleteFiles", "qbtPass", "qbtUrl", "qbtUser", "qbtWebhookSecret", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "torrentCopyBatchSize", "torrentDownloadsDir", "torrentJackettQbtBaseUrl", "torrentQbtCategory", "torrentQbtPollBatchSize", "torrentRunUnmatchedAutoStart", "torrentRunUnmatchedLimit", "torrentRunUnmatchedLimitPerIndexer", "torrentRunUnmatchedMinSeeders", "torrentRunUnmatchedParallelSearches", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexMatchForce", "yandexMatchTarget", "yandexPushTarget", "yandexToken") SELECT "allowRepush", "backupCron", "backupDir", "backupEnabled", "backupRetention", "copyInProgress", "createdAt", "cronCustomMatch", "cronCustomPush", "cronLidarr", "cronLidarrPull", "cronNavidromePush", "cronTorrentCopyDownloaded", "cronTorrentQbtPoll", "cronTorrentRunUnmatched", "cronYandex", "cronYandexMatch", "cronYandexPull", "cronYandexPush", "customMatchForce", "enableCronCustomMatch", "enableCronCustomPush", "enableCronLidarrPull", "enableCronNavidromePush", "enableCronTorrentCopyDownloaded", "enableCronTorrentQbtPoll", "enableCronTorrentRunUnmatched", "enableCronYandexMatch", "enableCronYandexPull", "enableCronYandexPush", "enableExport", "enablePush", "exportPath", "fileOpMode", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrPullTarget", "lidarrUrl", "likesPolicySourcePriority", "matchRetryDays", "mbMatchForce", "metadataProfileId", "mode", "monitor", "musicAlbumFolderPattern", "musicArtistFolderPattern", "musicDiscFolderPattern", "musicLibraryDir", "musicTrackFilePattern", "musicVariousArtistsName", "navidromePass", "navidromeSalt", "navidromeSyncTarget", "navidromeToken", "navidromeUrl", "navidromeUser", "notifyType", "pushTarget", "pyproxyUrl", "qbtDeleteFiles", "qbtPass", "qbtUrl", "qbtUser", "qbtWebhookSecret", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "torrentCopyBatchSize", "torrentDownloadsDir", "torrentJackettQbtBaseUrl", "torrentQbtCategory", "torrentQbtPollBatchSize", "torrentRunUnmatchedAutoStart", "torrentRunUnmatchedLimit", "torrentRunUnmatchedLimitPerIndexer", "torrentRunUnmatchedMinSeeders", "torrentRunUnmatchedParallelSearches", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexMatchForce", "yandexMatchTarget", "yandexPushTarget", "yandexToken" FROM "Setting";
DROP TABLE "Setting";
