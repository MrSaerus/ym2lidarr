...
CREATE TABLE "new_Setting" (
    ...
    "yandexCron" TEXT,
    "lidarrCron" TEXT,
    "cronCustomMatch" TEXT,
    "cronCustomPush" TEXT,
    "cronYandexPull" TEXT,
    "cronYandexMatch" TEXT,
    "cronYandexPush" TEXT,
...
INSERT INTO "new_Setting" ("backupCron", "backupDir", "backupEnabled", "backupRetention", "createdAt", "cronLidarr", "cronYandex", "enableExport", "enablePush", "exportPath", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrUrl", "metadataProfileId", "mode", "monitor", "notifyType", "pushTarget", "pyproxyUrl", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexToken") SELECT "backupCron", "backupDir", "backupEnabled", "backupRetention", "createdAt", "cronLidarr", "cronYandex", "enableExport", "enablePush", "exportPath", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrUrl", "metadataProfileId", "mode", "monitor", "notifyType", "pushTarget", "pyproxyUrl", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexToken" FROM "Setting";
DROP TABLE "Setting";
