...
CREATE TABLE "new_Setting" (
    ...
    "torrentRunUnmatchedAutoStart" BOOLEAN,
...
INSERT INTO "new_Setting" ("allowRepush", "backupCron", "backupDir", "backupEnabled", "backupRetention", "copyInProgress", "createdAt", "cronCustomMatch", "cronCustomPush", "cronLidarr", "cronLidarrPull", "cronNavidromePush", "cronYandex", "cronYandexMatch", "cronYandexPull", "cronYandexPush", "enableCronCustomMatch", "enableCronCustomPush", "enableCronLidarrPull", "enableCronNavidromePush", "enableCronYandexMatch", "enableCronYandexPull", "enableCronYandexPush", "enableExport", "enablePush", "exportPath", "fileOpMode", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrPullTarget", "lidarrUrl", "likesPolicySourcePriority", "matchRetryDays", "metadataProfileId", "mode", "monitor", "musicAlbumFolderPattern", "musicArtistFolderPattern", "musicDiscFolderPattern", "musicLibraryDir", "musicTrackFilePattern", "musicVariousArtistsName", "navidromePass", "navidromeSalt", "navidromeSyncTarget", "navidromeToken", "navidromeUrl", "navidromeUser", "notifyType", "pushTarget", "pyproxyUrl", "qbtDeleteFiles", "qbtPass", "qbtUrl", "qbtUser", "qbtWebhookSecret", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "torrentDownloadsDir", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexMatchTarget", "yandexPushTarget", "yandexToken") SELECT "allowRepush", "backupCron", "backupDir", "backupEnabled", "backupRetention", "copyInProgress", "createdAt", "cronCustomMatch", "cronCustomPush", "cronLidarr", "cronLidarrPull", "cronNavidromePush", "cronYandex", "cronYandexMatch", "cronYandexPull", "cronYandexPush", "enableCronCustomMatch", "enableCronCustomPush", "enableCronLidarrPull", "enableCronNavidromePush", "enableCronYandexMatch", "enableCronYandexPull", "enableCronYandexPush", "enableExport", "enablePush", "exportPath", "fileOpMode", "id", "lidarrAllowNoMetadata", "lidarrApiKey", "lidarrCron", "lidarrPullTarget", "lidarrUrl", "likesPolicySourcePriority", "matchRetryDays", "metadataProfileId", "mode", "monitor", "musicAlbumFolderPattern", "musicArtistFolderPattern", "musicDiscFolderPattern", "musicLibraryDir", "musicTrackFilePattern", "musicVariousArtistsName", "navidromePass", "navidromeSalt", "navidromeSyncTarget", "navidromeToken", "navidromeUrl", "navidromeUser", "notifyType", "pushTarget", "pyproxyUrl", "qbtDeleteFiles", "qbtPass", "qbtUrl", "qbtUser", "qbtWebhookSecret", "qualityProfileId", "rootFolderPath", "telegramBot", "telegramChatId", "torrentDownloadsDir", "updatedAt", "webhookSecret", "webhookUrl", "yandexCron", "yandexDriver", "yandexMatchTarget", "yandexPushTarget", "yandexToken" FROM "Setting";
DROP TABLE "Setting";
