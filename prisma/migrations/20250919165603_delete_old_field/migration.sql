/*
  ...
  - You are about to drop the column `jackettApiKey` on the `Setting` table. All the data in the column will be lost.
  - You are about to drop the column `jackettBaseUrl` on the `Setting` table. All the data in the column will be lost.
  - You are about to drop the column `jackettCategories` on the `Setting` table. All the data in the column will be lost.
  - You are about to drop the column `jackettEnabled` on the `Setting` table. All the data in the column will be lost.
  - You are about to drop the column `jackettRateLimitPerIndexer` on the `Setting` table. All the data in the column will be lost.
  - You are about to drop the column `jackettTimeoutMs` on the `Setting` table. All the data in the column will be lost.
