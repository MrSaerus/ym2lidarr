...
clean:
	rm -rf apps/**/dist/ apps/api/coverage apps/api/reports apps/api/junit.xml  apps/web/.next apps/web/out apps/pyproxy/.venv apps/pyproxy/__pycache__ apps/pyproxy/requirements.in apps/web/public/example.js apps/api/src/generated node_modules
